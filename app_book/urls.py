...
from ICECREAM.wrappers import pass_data, db_handler, jsonify
...
class BookApp(BaseApp):
    def call_router(self, core):
        ...
        core.route('/getquote/<pk>', 'GET', get_quote, apply=[db_handler, jsonify])
        core.route('/deletequote/<pk>', 'GET', delete_quote, apply=[db_handler, jsonify])
