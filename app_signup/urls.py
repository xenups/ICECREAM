...
class SignUpApp(BaseApp):
    def call_router(self, core):
        core.route('/register/activate-phone', 'POST', phone_activation, apply=[db_handler, pass_data])
        core.route('/register/validate-phone', 'POST', phone_validation, apply=[db_handler, pass_data])
